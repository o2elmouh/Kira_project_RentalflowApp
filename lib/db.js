...
function contractToDb(c) {
  return {
    ...
    actual_return_date: c.actualReturnDate || c.actual_return_date || null,
    ...
    mileage_end:      c.mileageIn       || c.mileage_end      || null,
    fuel_level_start: c.fuelLevel       || c.fuel_level_start || null,
    fuel_level_end:   c.fuelLevelEnd    || c.fuel_level_end   || null,
