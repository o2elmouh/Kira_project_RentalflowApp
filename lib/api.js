...
export const api = {
  ...
  // E-signature: dispatch the WhatsApp signing link to the client.
  sendContractSignLink: (contractId, unsignedPdfPath) =>
    request('POST', `/contracts/${contractId}/send-whatsapp`, { unsigned_pdf_path: unsignedPdfPath }),
