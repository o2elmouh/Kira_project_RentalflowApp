...
- Wire Resend email provider (`server/routes/email.js` — needs `RESEND_API_KEY`)
- **Law 09-08 compliance:** Phase 5 in progress — 5a shipped v1.10.6 (encryption groundwork, flag off). Remaining: 5b (v1.10.7 frontend switch) and 5c (v1.10.8 flip `ENCRYPT_PII=true`). See [.claude/PHASE_PLAN.md](PHASE_PLAN.md).
