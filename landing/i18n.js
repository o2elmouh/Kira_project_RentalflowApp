...
const AR = {
  ...
  'sig.title': 'التوقيع اللي كيدخل فواتساب',
  'sig.sub': 'صاوب العقد، صيفط رابط التوقيع عبر واتساب، والزبون كيوقّع من تيليفونو — وكتوصلك إشعار فالحين.',
  'sig.cta': 'جرّب التوقيع',
